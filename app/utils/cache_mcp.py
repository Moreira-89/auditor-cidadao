"""
Cache de tools (MCP + nativas) no Redis, com TTL. Contexto completo — por que Redis
em vez de cache em memória, serialização, normalização de chave — em
docs/arquitetura/protocolo_mcp.md#cache-das-ferramentas-aplicar_cache.
"""
